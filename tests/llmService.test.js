...
describe('LlmService', () => {
  ...
  test('should load and use Ollama provider when configured', async () => {
    ...
    mockOllamaGenerate.mockResolvedValue({ text: 'Ollama says hello', costData: null });
  ...
  test('should load and use Gemini provider when configured', async () => {
    ...
    mockGeminiGenerate.mockResolvedValue({ text: 'Gemini says hi', costData: null });
  ...
  test('should default to Ollama provider if an unsupported provider is configured', async () => {
    ...
    mockOllamaGenerate.mockResolvedValue({ text: 'Ollama default response', costData: null });
  ...
  test('should pass options to the provider', async () => {
    ...
    mockOllamaGenerate.mockResolvedValue({ text: 'Ollama with options', costData: null });
