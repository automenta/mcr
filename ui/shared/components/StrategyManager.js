...
class StrategyManager extends ManagerComponent {
  ...
  render() {
    super.render();
    this.querySelector('#item-select').addEventListener('change', this.onItemSelected.bind(this));
    this.querySelector('#create-item').addEventListener('click', this.createItem.bind(this));
    this.querySelector('#delete-item').addEventListener('click', this.deleteItem.bind(this));
    this.querySelector('#update-item').addEventListener('click', this.updateItem.bind(this));
  }
