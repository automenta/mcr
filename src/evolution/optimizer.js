...
const { initDb, closeDb } = require('../database'); // Removed DB_PATH // Assuming DB_PATH is exported for direct queries if needed
// const sqlite3 = require('sqlite3').verbose(); // Removed sqlite3
