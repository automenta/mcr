...
function fillTemplate(template, variables) {
  ...
  if (remainingPlaceholders) {
    ...
    for (const origPlaceholder of originalPlaceholders) {
      ...
      if (!Object.prototype.hasOwnProperty.call(variables, keyName)) {
        throw new Error(
...
function getPromptTemplateByName(templateName) {
  if (Object.prototype.hasOwnProperty.call(prompts, templateName)) {
    return prompts[templateName];
  } else if (
    Object.prototype.hasOwnProperty.call(dynamicPrompts, templateName)
  ) {
...
module.exports = {
  ...
  // For testing or if other modules need access to dynamic prompts directly
