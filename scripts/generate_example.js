...
async function generateExamples(
  ...
  logger.info(
    `Generating evaluation examples for domain: "${domain}" with instructions: "${instructions}" using ${llmProviderName}`
  );
  ...
  const filledPrompt = fillTemplate(prompts.GENERATE_EVAL_CASES.user, {
    domain,
    instructions,
  });
